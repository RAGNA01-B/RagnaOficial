...
//conn.sendFile(m.chat, img, 'letra.jpg', `ღ ${mid.smsYT1} :\n💚 *${result[0].title || ''}*\n\nღ ${mid.smsYT2} :\n💜 *${result[0].artist || ''}*\n\nღ ${mid.smsYT3} :\n${lyrics || ''}`, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝗦𝗨𝗣𝗘𝗥 𝗥𝗔𝗚𝗡𝗔𝗕𝗢𝗧 - 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
