...
correo = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/ragnabot.dzn' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/ragnabot.dzn' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/ragnabot.dzn' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'ragnabot' : official[1][0] == String(contact[0]) ? 'ragnabot' : official[2][0] == String(contact[0]) ? 'ragnabot' : official[3][0] == String(contact[0]) ? 'ragnabot' : country === '' ? lenguajeGB.smsContacto7() : country
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.instagram.com/ragnabot.dzn' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' ragnabot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
...
//------- Nombre
  ...
  let insta = `https://www.instagram.com/ragnabot.dzn`
  let teksnomor = `
• @${wm.split`@`[0]} •
------- ${wm} -------
`
