...
//this.reply(m.chat, `𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙍𝘼𝙂𝙉𝘼𝘾𝙊𝙄𝙉𝙎`, m)
this.sendMessage(m.chat, {text: `𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙍𝘼𝙂𝙉𝘼𝘾𝙊𝙄𝙉𝙎`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' RagnaBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
			
m.exp += xp
if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' RagnaBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
//this.reply(m.chat, `${lenguajeGB['smsCont7']()} *${usedPrefix}buy*`, m)
continue //Sin límite
}
if (plugin.level > _user.level) {
this.sendMessage(m.chat, {text: `${lenguajeGB['smsCont9']()} *${plugin.level}* ${lenguajeGB['smsCont10']()} *${_user.level}* ${lenguajeGB['smsCont11']()} *${usedPrefix}nivel*`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' RagnaBot ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
...
if (m.money)
m.reply(+m.money + ' 𝙍𝘼𝙂𝙉𝘼𝘾𝙊𝙄𝙉𝙎 𝙂𝘼𝙎𝙏𝘼𝘿𝙊(𝙎)')  
break
}}} catch (e) {
console.error(e)
} finally {
...
"thumbnail": apii.data, 
"title": [wm, 'RagnaBot ' + gt + ' ', '@ragnabot.dzn'].getRandom(),
"containsAutoReply": true,
"mediaType": 1, 
sourceUrl: 'https://whatsapp.com/channel/0029VaxGHbk0VycH76kD4M1w' }}}, { quoted: fkontak2 })
apii.data = ''
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, 'RagnaBot ' + gt + ' ', '@ragnabot.dzn'].getRandom(), thumbnail: gataImg, sourceUrl: accountsgb }}}}, tg)
